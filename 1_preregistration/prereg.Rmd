...
Click here to download the `r embed_file(here("1_preregistration/toy_data.RData"), text = "toy data")` if you want to reproduce the results.
...
osc_toy <- rio::import(here("1_preregistration/toy_data.RData"))
